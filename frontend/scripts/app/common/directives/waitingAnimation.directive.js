(function() {
  ...
  angular
    .module('app.common')
    .directive('waitingAnimation', waitingAnimation);

  function waitingAnimation($timeout, requestSpinnerEvents) {
    return {
      restrict: 'E',
      templateUrl: 'scripts/app/templates/directives/waiting-animation.html',
      link: link,
      scope: {}
    };
